...
public class KafkaEventListenerProviderFactory implements EventListenerProviderFactory {
  ...
  public EventListenerProvider create(KeycloakSession session) {
    return new KafkaEventListenerProvider(
        session, topicUser, topicAdmin, sync, cfg, enableUserEvents, enableAdminEvents, new KafkaEventFilter(userEvents, adminEvents));
  }
  ...
  public void init(Config.Scope root) {
    ...
    userEvents = root.get("user-events", "REGISTER,UPDATE_EMAIL,DELETE_ACCOUNT");

    adminEvents = root.get("admin-events", "CREATE:USER,UPDATE:USER,DELETE:USER");
